...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("txtEmail").equals("")) stMensaje += "Ingrese Email,";
            if (request.getParameter("txtPassword").equals("")) stMensaje += "Ingrese Contraseña,";
